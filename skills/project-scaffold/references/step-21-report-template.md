...
7. AGENTS.md's cloud-session contract line was checked at Step 10: it names your
   repositories (private repo), uses the public form (public repo), or is gone (no
   contract repos)
